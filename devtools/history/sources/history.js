...
class HorizontalCarouselElement extends CrLitElement {
    ...
    onCarouselForwardClick_() {
        ...
        this.showForwardButton_ = targetPosition + this.$.carouselContainer.clientWidth < this.$.carouselContainer.scrollWidth;
    ...
    setShowCarouselButtons_() {
        if (Math.round(this.$.carouselContainer.scrollLeft) + this.$.carouselContainer.clientWidth < this.$.carouselContainer.scrollWidth) {
            this.showForwardButton_ = true
        } else {
    ...
    calculateTargetPosition_(direction) {
        ...
        return Math.max(0, Math.min(targetPosition, this.$.carouselContainer.scrollWidth - this.$.carouselContainer.clientWidth))
    }
}
...
mojo.internal.Struct(TimeSpec.$, "Time", [mojo.internal.StructField("internalValue", 0, 0, mojo.internal.Int64, BigInt(0), false, 0, undefined, undefined)], [[0, 16]]);
const converterForJSTime = new JsTimeConverter;
mojo.internal.TypemappedStruct(JSTimeSpec.$, "JSTime", JSTimeDataView, converterForJSTime, [mojo.internal.StructField("msec", 0, 0, mojo.internal.Double, 0, false, 0, undefined, (value => converterForJSTime.msec(value)))], [[0, 16]]);
mojo.internal.Struct(TimeDeltaSpec.$, "TimeDelta", [mojo.internal.StructField("microseconds", 0, 0, mojo.internal.Int64, BigInt(0), false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(TimeTicksSpec.$, "TimeTicks", [mojo.internal.StructField("internalValue", 0, 0, mojo.internal.Int64, BigInt(0), false, 0, undefined, undefined)], [[0, 16]]);
...
mojo.internal.Struct(MatchPositionSpec.$, "MatchPosition", [mojo.internal.StructField("begin", 0, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined), mojo.internal.StructField("end", 4, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(SearchQuerySpec$1.$, "SearchQuery", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("url", 8, 0, UrlSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(RawVisitDataSpec.$, "RawVisitData", [mojo.internal.StructField("url", 0, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("visitTime", 8, 0, TimeSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(URLVisitSpec.$, "URLVisit", [mojo.internal.StructField("visitId", 0, 0, mojo.internal.Int64, BigInt(0), false, 0, undefined, undefined), mojo.internal.StructField("normalizedUrl", 8, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("urlForDisplay", 16, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("pageTitle", 24, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("titleMatchPositions", 32, 0, mojo.internal.Array(MatchPositionSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("urlForDisplayMatchPositions", 40, 0, mojo.internal.Array(MatchPositionSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("rawVisitData", 48, 0, RawVisitDataSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("duplicates", 56, 0, mojo.internal.Array(RawVisitDataSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("relativeDate", 64, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("annotations", 72, 0, mojo.internal.Array(AnnotationSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("isKnownToSync", 80, 0, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("debugInfo", 88, 0, mojo.internal.Map(mojo.internal.String, mojo.internal.String, false), null, false, 0, undefined, undefined), mojo.internal.StructField("hasUrlKeyedImage", 80, 1, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 104]]);
mojo.internal.Struct(ClusterSpec.$, "Cluster", [mojo.internal.StructField("id", 0, 0, mojo.internal.Int64, BigInt(0), false, 0, undefined, undefined), mojo.internal.StructField("visits", 8, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("label", 16, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("tabGroupName", 24, 0, mojo.internal.String, null, true, 0, undefined, undefined), mojo.internal.StructField("labelMatchPositions", 32, 0, mojo.internal.Array(MatchPositionSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("relatedSearches", 40, 0, mojo.internal.Array(SearchQuerySpec$1.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("imageUrl", 48, 0, UrlSpec.$, null, true, 0, undefined, undefined), mojo.internal.StructField("fromPersistence", 56, 0, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("debugInfo", 64, 0, mojo.internal.String, null, true, 0, undefined, undefined)], [[0, 80]]);
({
    $: mojo.internal.Enum()
});
...
let PageHandlerRemote$1 = class PageHandlerRemote {
    ...
    onConnectionError;
    constructor(handle) {
        this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(PageHandlerPendingReceiver$1,handle);
        this.$ = new mojo.internal.interfaceSupport.InterfaceRemoteBaseWrapper(this.proxy);
        this.onConnectionError = this.proxy.getConnectionErrorEventRouter()
    }
    openHistoryUrl(url, clickModifiers) {
        this.proxy.sendMessage(2003062467, PageHandler_OpenHistoryUrl_ParamsSpec.$, null, [url, clickModifiers], false)
    }
    setPage(page) {
        this.proxy.sendMessage(251246766, PageHandler_SetPage_ParamsSpec$1.$, null, [page], false)
    }
    showContextMenuForSearchbox(query, point) {
        this.proxy.sendMessage(2007195044, PageHandler_ShowContextMenuForSearchbox_ParamsSpec.$, null, [query, point], false)
    }
    showContextMenuForURL(url, point) {
        this.proxy.sendMessage(1786785708, PageHandler_ShowContextMenuForURL_ParamsSpec.$, null, [url, point], false)
    }
    showSidePanelUI() {
        this.proxy.sendMessage(147658244, PageHandler_ShowSidePanelUI_ParamsSpec.$, null, [], false)
    }
    toggleVisibility(visible) {
        return this.proxy.sendMessage(2004387087, PageHandler_ToggleVisibility_ParamsSpec.$, PageHandler_ToggleVisibility_ResponseParamsSpec.$, [visible], false)
    }
    startQueryClusters(query, beginTime, recluster) {
        this.proxy.sendMessage(260786406, PageHandler_StartQueryClusters_ParamsSpec.$, null, [query, beginTime, recluster], false)
    }
    loadMoreClusters(query) {
        this.proxy.sendMessage(923183448, PageHandler_LoadMoreClusters_ParamsSpec.$, null, [query], false)
    }
    hideVisits(visits) {
        return this.proxy.sendMessage(1609500825, PageHandler_HideVisits_ParamsSpec.$, PageHandler_HideVisits_ResponseParamsSpec.$, [visits], false)
    }
    removeVisits(visits) {
        return this.proxy.sendMessage(1550462100, PageHandler_RemoveVisits_ParamsSpec.$, PageHandler_RemoveVisits_ResponseParamsSpec.$, [visits], false)
    }
    removeVisitByUrlAndTime(url, timestamp) {
        return this.proxy.sendMessage(838615482, PageHandler_RemoveVisitByUrlAndTime_ParamsSpec.$, PageHandler_RemoveVisitByUrlAndTime_ResponseParamsSpec.$, [url, timestamp], false)
    }
    openVisitUrlsInTabGroup(visits, tabGroupName) {
        this.proxy.sendMessage(1805122344, PageHandler_OpenVisitUrlsInTabGroup_ParamsSpec.$, null, [visits, tabGroupName], false)
    }
    recordVisitAction(visitAction, visitIndex, visitType) {
        this.proxy.sendMessage(137828852, PageHandler_RecordVisitAction_ParamsSpec.$, null, [visitAction, visitIndex, visitType], false)
    }
    recordRelatedSearchAction(action, visitIndex) {
        this.proxy.sendMessage(501602679, PageHandler_RecordRelatedSearchAction_ParamsSpec.$, null, [action, visitIndex], false)
    }
    recordClusterAction(clusterAction, clusterIndex) {
        this.proxy.sendMessage(102376420, PageHandler_RecordClusterAction_ParamsSpec.$, null, [clusterAction, clusterIndex], false)
    }
    recordToggledVisibility(visible) {
        this.proxy.sendMessage(1450255869, PageHandler_RecordToggledVisibility_ParamsSpec.$, null, [visible], false)
    }
}
;
...
let PageRemote$1 = class PageRemote {
    ...
    onConnectionError;
    constructor(handle) {
        this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(PagePendingReceiver$1,handle);
        this.$ = new mojo.internal.interfaceSupport.InterfaceRemoteBaseWrapper(this.proxy);
        this.onConnectionError = this.proxy.getConnectionErrorEventRouter()
    }
    onClustersQueryResult(result) {
        this.proxy.sendMessage(548800450, Page_OnClustersQueryResult_ParamsSpec.$, null, [result], false)
    }
    onClusterImageUpdated(clusterIndex, imageUrl) {
        this.proxy.sendMessage(563686325, Page_OnClusterImageUpdated_ParamsSpec.$, null, [clusterIndex, imageUrl], false)
    }
    onVisitsHidden(hiddenVisits) {
        this.proxy.sendMessage(1668805530, Page_OnVisitsHidden_ParamsSpec.$, null, [hiddenVisits], false)
    }
    onVisitsRemoved(removedVisits) {
        this.proxy.sendMessage(1696954030, Page_OnVisitsRemoved_ParamsSpec.$, null, [removedVisits], false)
    }
    onHistoryDeleted() {
        this.proxy.sendMessage(1692116436, Page_OnHistoryDeleted_ParamsSpec.$, null, [], false)
    }
    onQueryChangedByUser(query) {
        this.proxy.sendMessage(2533938, Page_OnQueryChangedByUser_ParamsSpec.$, null, [query], false)
    }
}
;
let PageCallbackRouter$1 = class PageCallbackRouter {
    ...
    constructor() {
        ...
        this.onClustersQueryResult = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(548800450, Page_OnClustersQueryResult_ParamsSpec.$, null, this.onClustersQueryResult.createReceiverHandler(false), false);
        this.onClusterImageUpdated = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(563686325, Page_OnClusterImageUpdated_ParamsSpec.$, null, this.onClusterImageUpdated.createReceiverHandler(false), false);
        this.onVisitsHidden = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1668805530, Page_OnVisitsHidden_ParamsSpec.$, null, this.onVisitsHidden.createReceiverHandler(false), false);
        this.onVisitsRemoved = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1696954030, Page_OnVisitsRemoved_ParamsSpec.$, null, this.onVisitsRemoved.createReceiverHandler(false), false);
        this.onHistoryDeleted = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1692116436, Page_OnHistoryDeleted_ParamsSpec.$, null, this.onHistoryDeleted.createReceiverHandler(false), false);
        this.onQueryChangedByUser = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(2533938, Page_OnQueryChangedByUser_ParamsSpec.$, null, this.onQueryChangedByUser.createReceiverHandler(false), false);
...
mojo.internal.Struct(QueryResultSpec.$, "QueryResult", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("clusters", 8, 0, mojo.internal.Array(ClusterSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("canLoadMore", 16, 0, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("isContinuation", 16, 1, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 32]]);
mojo.internal.Struct(PageHandler_OpenHistoryUrl_ParamsSpec.$, "PageHandler_OpenHistoryUrl_Params", [mojo.internal.StructField("url", 0, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("clickModifiers", 8, 0, ClickModifiersSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_SetPage_ParamsSpec$1.$, "PageHandler_SetPage_Params", [mojo.internal.StructField("page", 0, 0, mojo.internal.InterfaceProxy(PageRemote$1), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_ShowContextMenuForSearchbox_ParamsSpec.$, "PageHandler_ShowContextMenuForSearchbox_Params", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("point", 8, 0, PointSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_ShowContextMenuForURL_ParamsSpec.$, "PageHandler_ShowContextMenuForURL_Params", [mojo.internal.StructField("url", 0, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("point", 8, 0, PointSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_ShowSidePanelUI_ParamsSpec.$, "PageHandler_ShowSidePanelUI_Params", [], [[0, 8]]);
mojo.internal.Struct(PageHandler_ToggleVisibility_ParamsSpec.$, "PageHandler_ToggleVisibility_Params", [mojo.internal.StructField("visible", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_ToggleVisibility_ResponseParamsSpec.$, "PageHandler_ToggleVisibility_ResponseParams", [mojo.internal.StructField("visible", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_StartQueryClusters_ParamsSpec.$, "PageHandler_StartQueryClusters_Params", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("beginTime", 8, 0, TimeSpec.$, null, true, 0, undefined, undefined), mojo.internal.StructField("recluster", 16, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 32]]);
mojo.internal.Struct(PageHandler_LoadMoreClusters_ParamsSpec.$, "PageHandler_LoadMoreClusters_Params", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_HideVisits_ParamsSpec.$, "PageHandler_HideVisits_Params", [mojo.internal.StructField("visits", 0, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_HideVisits_ResponseParamsSpec.$, "PageHandler_HideVisits_ResponseParams", [mojo.internal.StructField("success", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_RemoveVisits_ParamsSpec.$, "PageHandler_RemoveVisits_Params", [mojo.internal.StructField("visits", 0, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_RemoveVisits_ResponseParamsSpec.$, "PageHandler_RemoveVisits_ResponseParams", [mojo.internal.StructField("success", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_RemoveVisitByUrlAndTime_ParamsSpec.$, "PageHandler_RemoveVisitByUrlAndTime_Params", [mojo.internal.StructField("url", 0, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("timestamp", 8, 0, mojo.internal.Double, 0, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_RemoveVisitByUrlAndTime_ResponseParamsSpec.$, "PageHandler_RemoveVisitByUrlAndTime_ResponseParams", [mojo.internal.StructField("success", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_OpenVisitUrlsInTabGroup_ParamsSpec.$, "PageHandler_OpenVisitUrlsInTabGroup_Params", [mojo.internal.StructField("visits", 0, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined), mojo.internal.StructField("tabGroupName", 8, 0, mojo.internal.String, null, true, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_RecordVisitAction_ParamsSpec.$, "PageHandler_RecordVisitAction_Params", [mojo.internal.StructField("visitAction", 0, 0, VisitActionSpec.$, 0, false, 0, undefined, undefined), mojo.internal.StructField("visitIndex", 4, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined), mojo.internal.StructField("visitType", 8, 0, VisitTypeSpec.$, 0, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_RecordRelatedSearchAction_ParamsSpec.$, "PageHandler_RecordRelatedSearchAction_Params", [mojo.internal.StructField("action", 0, 0, RelatedSearchActionSpec.$, 0, false, 0, undefined, undefined), mojo.internal.StructField("visitIndex", 4, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_RecordClusterAction_ParamsSpec.$, "PageHandler_RecordClusterAction_Params", [mojo.internal.StructField("clusterAction", 0, 0, ClusterActionSpec.$, 0, false, 0, undefined, undefined), mojo.internal.StructField("clusterIndex", 4, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_RecordToggledVisibility_ParamsSpec.$, "PageHandler_RecordToggledVisibility_Params", [mojo.internal.StructField("visible", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(Page_OnClustersQueryResult_ParamsSpec.$, "Page_OnClustersQueryResult_Params", [mojo.internal.StructField("result", 0, 0, QueryResultSpec.$, null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(Page_OnClusterImageUpdated_ParamsSpec.$, "Page_OnClusterImageUpdated_Params", [mojo.internal.StructField("clusterIndex", 0, 0, mojo.internal.Int32, 0, false, 0, undefined, undefined), mojo.internal.StructField("imageUrl", 8, 0, UrlSpec.$, null, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(Page_OnVisitsHidden_ParamsSpec.$, "Page_OnVisitsHidden_Params", [mojo.internal.StructField("hiddenVisits", 0, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(Page_OnVisitsRemoved_ParamsSpec.$, "Page_OnVisitsRemoved_Params", [mojo.internal.StructField("removedVisits", 0, 0, mojo.internal.Array(URLVisitSpec.$, false), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(Page_OnHistoryDeleted_ParamsSpec.$, "Page_OnHistoryDeleted_Params", [], [[0, 8]]);
mojo.internal.Struct(Page_OnQueryChangedByUser_ParamsSpec.$, "Page_OnQueryChangedByUser_Params", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined)], [[0, 16]]);
...
class PageImageServiceHandlerRemote {
    ...
    onConnectionError;
    constructor(handle) {
        this.proxy = new mojo.internal.interfaceSupport.InterfaceRemoteBase(PageImageServiceHandlerPendingReceiver,handle);
        this.$ = new mojo.internal.interfaceSupport.InterfaceRemoteBaseWrapper(this.proxy);
        this.onConnectionError = this.proxy.getConnectionErrorEventRouter()
    }
    getPageImageUrl(clientId, pageUrl, options) {
        return this.proxy.sendMessage(689651550, PageImageServiceHandler_GetPageImageUrl_ParamsSpec.$, PageImageServiceHandler_GetPageImageUrl_ResponseParamsSpec.$, [clientId, pageUrl, options], false)
    }
}
...
mojo.internal.Struct(OptionsSpec.$, "Options", [mojo.internal.StructField("suggestImages", 0, 0, mojo.internal.Bool, true, false, 0, undefined, undefined), mojo.internal.StructField("optimizationGuideImages", 0, 1, mojo.internal.Bool, true, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(ImageResultSpec.$, "ImageResult", [mojo.internal.StructField("imageUrl", 0, 0, UrlSpec.$, null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageImageServiceHandler_GetPageImageUrl_ParamsSpec.$, "PageImageServiceHandler_GetPageImageUrl_Params", [mojo.internal.StructField("clientId", 0, 0, ClientIdSpec.$, 0, false, 0, undefined, undefined), mojo.internal.StructField("pageUrl", 8, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("options", 16, 0, OptionsSpec.$, null, false, 0, undefined, undefined)], [[0, 32]]);
mojo.internal.Struct(PageImageServiceHandler_GetPageImageUrl_ResponseParamsSpec.$, "PageImageServiceHandler_GetPageImageUrl_ResponseParams", [mojo.internal.StructField("result", 0, 0, ImageResultSpec.$, null, true, 0, undefined, undefined)], [[0, 16]]);
class PageImageServiceBrowserProxy {
    ...
    static getInstance() {
        return instance$x || (instance$x = new PageImageServiceBrowserProxy(PageImageServiceHandler.getRemote()))
    }
    static setInstance(obj) {
        instance$x = obj
    }
    ...
    willUpdate(changedProperties) {
        ...
        if (changedProperties.has("url") || changedProperties.has("imageUrl_")) {
            if (this.imageUrl_ && this.imageUrl_.url || !this.url) {
                ...
                this.style.setProperty("background-image", getFaviconForPageURL(this.url.url, this.isKnownToSync, "", 16))
            }
        }
        if (changedProperties.has("url") || changedProperties.has("isKnownToSync")) {
            this.urlAndIsKnownToSyncChanged_()
        }
    }
    async urlAndIsKnownToSyncChanged_() {
        if (!this.url || !this.isKnownToSync || !loadTimeData.getBoolean("isHistoryClustersImagesEnabled")) {
            this.imageUrl_ = null;
            return
        }
        const {result: result} = await PageImageServiceBrowserProxy.getInstance().handler.getPageImageUrl(ClientId.Journeys, this.url, {
            suggestImages: true,
...
class UrlVisitElement extends ClusterMenuElementBase {
    ...
    onContextMenu_(event) {
        ...
        BrowserProxyImpl.getInstance().handler.showContextMenuForURL(this.visit.normalizedUrl, {
            x: event.clientX,
            y: event.clientY
        })
    }
    ...
    computeAnnotations_() {
        ...
        return this.visit.annotations.map((annotation => annotationToStringId.get(annotation))).filter((id => !!id)).map((id => loadTimeData.getString(id)))
    }
    computeDebugInfo_() {
...
class ClusterElement extends ClusterElementBase {
    ...
    connectedCallback() {
        super.connectedCallback();
        this.onVisitsHiddenListenerId_ = this.callbackRouter_.onVisitsHidden.addListener(this.onVisitsRemovedOrHidden_.bind(this));
        this.onVisitsRemovedListenerId_ = this.callbackRouter_.onVisitsRemoved.addListener(this.onVisitsRemovedOrHidden_.bind(this))
    }
    disconnectedCallback() {
        super.disconnectedCallback();
    ...
    willUpdate(changedProperties) {
        ...
        if (changedProperties.has("cluster")) {
            ...
            this.relatedSearches_ = this.cluster.relatedSearches.filter(( (query, index) => query && !(this.inSidePanel && index > 2)))
        }
    }
    updated(changedProperties) {
        super.updated(changedProperties);
        const changedPrivateProperties = changedProperties;
        if (changedPrivateProperties.has("label_") && this.label_ !== "no_label" && this.cluster) {
    ...
    onVisitsRemovedOrHidden_(removedVisits) {
        assert(this.cluster);
        const visitHasBeenRemoved = visit => removedVisits.findIndex((removedVisit => {
            if (visit.normalizedUrl.url !== removedVisit.normalizedUrl.url) {
                return false
            }
            const rawVisitTime = visit.rawVisitData.visitTime.internalValue;
            return removedVisit.rawVisitData.visitTime.internalValue === rawVisitTime || removedVisit.duplicates.map((data => data.visitTime.internalValue)).includes(rawVisitTime)
        }
        )) !== -1;
    ...
    timestamp_() {
        return this.cluster && this.cluster.visits.length > 0 ? this.cluster.visits[0].relativeDate : ""
    }
    visits_() {
...
let instance$s = null;
function getCss$q() {
    return instance$s || (instance$s = [...[], css`:host{display:block;position:relative}:host([using-default-scroll-target]){overflow-y:auto}`])
}
...
class HistoryClustersElement extends HistoryClustersElementBase {
    ...
    connectedCallback() {
        ...
        this.onClustersQueryResultListenerId_ = this.callbackRouter_.onClustersQueryResult.addListener(this.onClustersQueryResult_.bind(this));
        this.onClusterImageUpdatedListenerId_ = this.callbackRouter_.onClusterImageUpdated.addListener(this.onClusterImageUpdated_.bind(this));
        this.onVisitsRemovedListenerId_ = this.callbackRouter_.onVisitsRemoved.addListener(this.onVisitsRemoved_.bind(this));
        this.onHistoryDeletedListenerId_ = this.callbackRouter_.onHistoryDeleted.addListener(this.onHistoryDeleted_.bind(this));
        this.onQueryChangedByUserListenerId_ = this.callbackRouter_.onQueryChangedByUser.addListener(this.onQueryChangedByUser_.bind(this));
    ...
    willUpdate(changedProperties) {
        super.willUpdate(changedProperties);
        if (changedProperties.has("query") || changedProperties.has("timeRangeStart")) {
            this.onQueryChanged_()
        }
        const changedPrivateProperties = changedProperties;
        if (changedPrivateProperties.has("hasResult_") || changedPrivateProperties.has("clusters_")) {
    ...
    updated(changedProperties) {
        ...
        if (changedPrivateProperties.has("clusters_")) {
            ...
            if (clustersRemoved && this.canLoadMore_ && this.$.clusters.offsetHeight < this.scrollTarget.offsetHeight) {
    ...
    onRemoveCluster_(event) {
        ...
        this.clusters_ = [...this.clusters_.slice(0, index), ...this.clusters_.slice(index + 1)]
    }
    ...
    computePlaceholderText_() {
        ...
        return this.clusters_.length ? "" : loadTimeData.getString(this.resultQuery_ ? "noSearchResults" : "historyClustersNoResults")
    }
    getLoadMoreButtonHidden_() {
        return !this.hasResult_ || this.clusters_.length === 0 || !this.canLoadMore_
    }
    ...
    onClustersQueryResult_(result) {
        ...
        this.onBrowserIdle_().then(( () => {
            if ((this.$.clusters.offsetHeight < this.scrollTarget.offsetHeight || this.scrollTarget.scrollHeight <= this.scrollTarget.clientHeight) && this.canLoadMore_) {
                this.onLoadMoreButtonClick_()
            }
        }
        ));
    ...
    onScrollTimeout_() {
        ...
        const lowerScroll = this.scrollTarget.scrollHeight - this.scrollTarget.scrollTop - this.scrollTarget.offsetHeight;
        if (lowerScroll < 500) {
...
class HistoryEmbeddingsFilterChips extends HistoryEmbeddingsFilterChipsElementBase {
    ...
    onTimeRangeStartChanged_() {
        if (this.timeRangeStart?.getTime() === this.selectedSuggestion?.timeRangeStart.getTime()) {
            return
        }
        this.selectedSuggestion = this.suggestions_.find((suggestion => suggestion.timeRangeStart.getTime() === this.timeRangeStart?.getTime()))
    }
...
let instance$m = null;
function getCss$k() {
    return instance$m || (instance$m = [...[], css`.buttons{--cr-feedback-buttons-icon-size_:16px;display:grid;grid-auto-columns:var(--cr-feedback-buttons-icon-size_);grid-auto-rows:var(--cr-feedback-buttons-icon-size_);grid-auto-flow:column;gap:12px;align-items:center;justify-items:center}cr-icon-button{--cr-icon-button-fill-color:currentColor;--cr-icon-button-icon-size:var(--cr-feedback-buttons-icon-size_);--cr-icon-button-size:24px;margin:0}`])
}
function getHtml$j() {
    return html`
<div class="buttons">
...
class CrFeedbackButtonsElement extends CrLitElement {
    ...
    getThumbsDownIcon_() {
        return this.selectedOption === CrFeedbackOption.THUMBS_DOWN ? "cr:thumbs-down-filled" : "cr:thumbs-down"
    }
    getThumbsUpAriaPressed_() {
        return this.selectedOption === CrFeedbackOption.THUMBS_UP
    }
    getThumbsUpIcon_() {
        return this.selectedOption === CrFeedbackOption.THUMBS_UP ? "cr:thumbs-up-filled" : "cr:thumbs-up"
    }
    async notifySelectedOptionChanged_() {
        await this.updateComplete;
        this.fire("selected-option-changed", {
            value: this.selectedOption
        })
    }
    onThumbsDownClick_() {
        this.selectedOption = this.selectedOption === CrFeedbackOption.THUMBS_DOWN ? CrFeedbackOption.UNSPECIFIED : CrFeedbackOption.THUMBS_DOWN;
        this.notifySelectedOptionChanged_()
    }
    onThumbsUpClick_() {
        this.selectedOption = this.selectedOption === CrFeedbackOption.THUMBS_UP ? CrFeedbackOption.UNSPECIFIED : CrFeedbackOption.THUMBS_UP;
        this.notifySelectedOptionChanged_()
    }
}
...
class CrUrlListItemElement extends CrUrlListItemElementBase {
    ...
    willUpdate(changedProperties) {
        super.willUpdate(changedProperties);
        if (changedProperties.has("hasBadges") || changedProperties.has("description")) {
            this.hasDescriptions_ = !!this.description || this.hasBadges || !!this.descriptionMeta
        }
    ...
    onBadgesSlotChange_() {
        this.hasBadges = this.$.badges.assignedElements({
            flatten: true
        }).length > 0
    }
    onContentSlotChange_() {
        this.hasSlottedContent_ = this.$.content.assignedElements({
            flatten: true
        }).length > 0
    }
    ...
    shouldShowFavicon_() {
        return this.url !== undefined && (this.size === CrUrlListItemSize.COMPACT || this.imageUrls.length === 0)
    }
    shouldShowUrlImage_() {
        return this.url !== undefined && !(this.size === CrUrlListItemSize.COMPACT || this.imageUrls.length === 0) && this.firstImageLoaded_
    }
    shouldShowFolderImages_() {
        return this.size !== CrUrlListItemSize.COMPACT
    }
    shouldShowFolderIcon_() {
        return this.size === CrUrlListItemSize.COMPACT || this.imageUrls.length === 0
    }
...
class HistoryEmbeddingsResultImageElement extends CrLitElement {
    ...
    async fetchImageForSearchResult_() {
        ...
        const {result: result} = await PageImageServiceBrowserProxy.getInstance().handler.getPageImageUrl(ClientId.HistoryEmbeddings, searchResultUrl, {
            suggestImages: true,
            optimizationGuideImages: true
        });
...
class PageHandlerRemote {
    ...
    setPage(page) {
        this.proxy.sendMessage(2003062467, PageHandler_SetPage_ParamsSpec.$, null, [page], false)
    }
    search(query) {
        this.proxy.sendMessage(251246766, PageHandler_Search_ParamsSpec.$, null, [query], false)
    }
    sendQualityLog(selectedIndices, numEnteredChars) {
        this.proxy.sendMessage(2007195044, PageHandler_SendQualityLog_ParamsSpec.$, null, [selectedIndices, numEnteredChars], false)
    }
    recordSearchResultsMetrics(nonEmptyResults, userClickedResult, answerShown, answerCitationClicked, otherHistoryResultClicked, queryWordCount) {
        this.proxy.sendMessage(1786785708, PageHandler_RecordSearchResultsMetrics_ParamsSpec.$, null, [nonEmptyResults, userClickedResult, answerShown, answerCitationClicked, otherHistoryResultClicked, queryWordCount], false)
    }
    setUserFeedback(feedback) {
        this.proxy.sendMessage(147658244, PageHandler_SetUserFeedback_ParamsSpec.$, null, [feedback], false)
    }
    maybeShowFeaturePromo() {
        this.proxy.sendMessage(2004387087, PageHandler_MaybeShowFeaturePromo_ParamsSpec.$, null, [], false)
    }
    openSettingsPage() {
        this.proxy.sendMessage(260786406, PageHandler_OpenSettingsPage_ParamsSpec.$, null, [], false)
    }
}
class PageHandler {
    static get $interfaceName() {
...
class PageRemote {
    ...
    searchResultChanged(result) {
        this.proxy.sendMessage(548800450, Page_SearchResultChanged_ParamsSpec.$, null, [result], false)
    }
}
class PageCallbackRouter {
    ...
    constructor() {
        ...
        this.$ = new mojo.internal.interfaceSupport.InterfaceReceiverHelper(this.helper_internal_);
        this.router_ = new mojo.internal.interfaceSupport.CallbackRouter;
        this.searchResultChanged = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(548800450, Page_SearchResultChanged_ParamsSpec.$, null, this.searchResultChanged.createReceiverHandler(false), false);
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter()
    }
    removeListener(id) {
        return this.router_.removeListener(id)
...
mojo.internal.Struct(AnswerDataSpec.$, "AnswerData", [mojo.internal.StructField("answerTextDirectives", 0, 0, mojo.internal.Array(mojo.internal.String, false), null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(SearchResultItemSpec.$, "SearchResultItem", [mojo.internal.StructField("title", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("url", 8, 0, UrlSpec.$, null, false, 0, undefined, undefined), mojo.internal.StructField("urlForDisplay", 16, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("relativeTime", 24, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("shortDateTime", 32, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("lastUrlVisitTimestamp", 40, 0, mojo.internal.Double, 0, false, 0, undefined, undefined), mojo.internal.StructField("sourcePassage", 48, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("answerData", 56, 0, AnswerDataSpec.$, null, true, 0, undefined, undefined), mojo.internal.StructField("isUrlKnownToSync", 64, 0, mojo.internal.Bool, false, false, 0, undefined, undefined)], [[0, 80]]);
mojo.internal.Struct(SearchQuerySpec.$, "SearchQuery", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("timeRangeStart", 8, 0, TimeSpec.$, null, true, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(SearchResultSpec.$, "SearchResult", [mojo.internal.StructField("query", 0, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("answerStatus", 8, 0, AnswerStatusSpec.$, 0, false, 0, undefined, undefined), mojo.internal.StructField("answer", 16, 0, mojo.internal.String, null, false, 0, undefined, undefined), mojo.internal.StructField("items", 24, 0, mojo.internal.Array(SearchResultItemSpec.$, false), null, false, 0, undefined, undefined)], [[0, 40]]);
...
mojo.internal.Struct(PageHandler_Search_ParamsSpec.$, "PageHandler_Search_Params", [mojo.internal.StructField("query", 0, 0, SearchQuerySpec.$, null, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_SendQualityLog_ParamsSpec.$, "PageHandler_SendQualityLog_Params", [mojo.internal.StructField("selectedIndices", 0, 0, mojo.internal.Array(mojo.internal.Uint32, false), null, false, 0, undefined, undefined), mojo.internal.StructField("numEnteredChars", 8, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined)], [[0, 24]]);
mojo.internal.Struct(PageHandler_RecordSearchResultsMetrics_ParamsSpec.$, "PageHandler_RecordSearchResultsMetrics_Params", [mojo.internal.StructField("nonEmptyResults", 0, 0, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("userClickedResult", 0, 1, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("answerShown", 0, 2, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("answerCitationClicked", 0, 3, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("otherHistoryResultClicked", 0, 4, mojo.internal.Bool, false, false, 0, undefined, undefined), mojo.internal.StructField("queryWordCount", 4, 0, mojo.internal.Uint32, 0, false, 0, undefined, undefined)], [[0, 16]]);
mojo.internal.Struct(PageHandler_SetUserFeedback_ParamsSpec.$, "PageHandler_SetUserFeedback_Params", [mojo.internal.StructField("feedback", 0, 0, UserFeedbackSpec.$, 0, false, 0, undefined, undefined)], [[0, 16]]);
...
mojo.internal.Struct(Page_SearchResultChanged_ParamsSpec.$, "Page_SearchResultChanged_Params", [mojo.internal.StructField("result", 0, 0, SearchResultSpec.$, null, false, 0, undefined, undefined)], [[0, 16]]);
class HistoryEmbeddingsBrowserProxyImpl {
    ...
    static getInstance() {
        ...
        handler.setPage(callbackRouter.$.bindNewPipeAndPassRemote());
        HistoryEmbeddingsBrowserProxyImpl.instance = new HistoryEmbeddingsBrowserProxyImpl(handler,callbackRouter);
        return HistoryEmbeddingsBrowserProxyImpl.instance
    }
...
class HistoryEmbeddingsElement extends HistoryEmbeddingsElementBase {
    ...
    connectedCallback() {
        ...
        this.searchResultChangedId_ = this.browserProxy_.callbackRouter.searchResultChanged.addListener(this.searchResultChanged_.bind(this))
    }
    disconnectedCallback() {
        super.disconnectedCallback();
        this.flushDebouncedUserMetrics_(true);
    ...
    willUpdate(changedProperties) {
        super.willUpdate(changedProperties);
        const changedPrivateProperties = changedProperties;
        if (changedPrivateProperties.has("loadingResults_") || changedPrivateProperties.has("searchResult_") || changedPrivateProperties.has("searchResultDirty_") && this.searchResultDirty_) {
            this.isEmpty = this.computeIsEmpty_()
        }
        if (changedPrivateProperties.has("loadingAnswer_") || changedPrivateProperties.has("searchResult_") || changedPrivateProperties.has("searchResultDirty_") && this.searchResultDirty_) {
            this.answerSource_ = this.computeAnswerSource_()
        }
        const isSearchQueryInitialization = changedProperties.get("searchQuery") === undefined && this.searchQuery === "";
        if (changedProperties.has("searchQuery") && !isSearchQueryInitialization || changedProperties.has("timeRangeStart")) {
            this.onSearchQueryChanged_()
        }
        if (changedPrivateProperties.has("searchResultDirty_") && this.searchResultDirty_) {
    ...
    onResultClick_(e) {
        ...
        this.browserProxy_.recordSearchResultsMetrics(true, true, this.hasAnswer_(), this.answerLinkClicked_, this.otherHistoryResultClicked, this.searchQuery.split(" ").length)
    }
    ...
    searchResultChangedImpl_(result) {
        ...
        if (shouldAnnounceForResults) {
            const resultsLabelId = result.items.length === 1 ? "historyEmbeddingsMatch" : "historyEmbeddingsMatches";
    ...
    showAnswerSection_() {
        if (!this.searchResult_) {
            ...
            return this.searchResult_.answerStatus !== AnswerStatus.kUnspecified && this.searchResult_.answerStatus !== AnswerStatus.kUnanswerable && this.searchResult_.answerStatus !== AnswerStatus.kFiltered && this.searchResult_.answerStatus !== AnswerStatus.kModelUnavailable
        }
    }
    flushDebouncedUserMetrics_(forceFlush=false) {
        ...
        const resultsWereStable = performance.now() - this.resultPendingMetricsTimestamp_ >= this.queryResultMinAge_;
        const canLog = resultsWereStable || forceFlush;
        if (canLog && !userClickedResult) {
            const nonEmptyResults = !!this.searchResult_ && this.searchResult_.items && this.searchResult_.items.length > 0;
            this.browserProxy_.recordSearchResultsMetrics(nonEmptyResults, false, this.hasAnswer_(), this.answerLinkClicked_, this.otherHistoryResultClicked, this.searchQuery.split(" ").length)
        }
...
let instance$g = null;
function getCss$e() {
    return instance$g || (instance$g = [...[], css`:host{display:block}:host(:not([show-all]))>::slotted(:not(slot):not(.selected)){display:none !important}`])
}
function getHtml$d() {
    return html`<slot></slot>`
}
...
function getPromoShownKey() {
    return loadTimeData.getBoolean("enableHistoryEmbeddingsAnswers") ? HISTORY_EMBEDDINGS_ANSWERS_PROMO_SHOWN_KEY : HISTORY_EMBEDDINGS_PROMO_SHOWN_KEY
}
...
const FocusRowMixinLit = superClass => {
    class FocusRowMixinLit extends superClass {
        ...
        willUpdate(changedProperties) {
            super.willUpdate(changedProperties);
            if (changedProperties.has("focusRowIndex") && this.focusRowIndex !== undefined) {
        ...
        <div id="item-container" focus-row-container>
          ...
          <div role="gridcell" id="options">
            <cr-icon-button id="menu-button" iron-icon="cr:more-vert"
                ...
                title="Actions" @click="${this.onMenuButtonClick_}"
...
class HistoryItemElement extends HistoryItemElementBase {
    ...
    onRowClick_(e) {
        ...
        for (let i = 0; i < path.length; i++) {
            const elem = path[i];
            if (elem.id !== "checkbox" && (elem.nodeName === "A" || elem.nodeName === "CR-ICON-BUTTON")) {
                return
            }
    ...
    getAriaDescribedByForActions_() {
        return this.isCardStart || this.isCardEnd ? "title-and-domain date-accessed" : "title-and-domain"
    }
    shouldShowActorTooltip_() {
        return loadTimeData.getBoolean("enableBrowsingHistoryActorIntegrationM1") && this.item?.isActorVisit
    }
    onRemoveBookmarkClick_() {
        if (!this.item?.starred) {
            return
        }
        if (this.shadowRoot.querySelector("#bookmark-star") === this.shadowRoot.activeElement) {
            focusWithoutInk(this.$["menu-button"])
        }
...
let instance$b = null;
function getCss$9() {
    return instance$b || (instance$b = [...[getCss$z(), getCss$C()], css`:host{box-sizing:border-box;display:block}:host([is-empty]){padding-block:80px}.history-cards{margin-block-start:var(--first-card-padding-top)}dialog [slot=body]{white-space:pre-wrap}.chunk{overflow-clip-margin:8px}`])
}
function getHtml$8() {
    return html`<!--_html_template_start_-->
    ...
    <cr-lazy-render-lit id="dialog" .template='${ () => html`
        <cr-dialog consume-keydown-event>
          <div slot="title" id="title">Delete selected items</div>
          <div slot="body" id="body">Are you sure you want to delete these pages from your history?</div>
          <div slot="button-container">
    ...
    <cr-lazy-render-lit id="sharedMenu" .template='${ () => html`
        <cr-action-menu role-description="Actions">
...
class HistoryListElement extends HistoryListElementBase {
    ...
    historyResult(info, results) {
        ...
        if (info.term && !this.queryState.incremental) {
            ...
            if (loadTimeData.getBoolean("enableHistoryEmbeddings")) {
                resultsLabelId = results.length === 1 ? "searchResultExactMatch" : "searchResultExactMatches"
            } else {
                resultsLabelId = results.length === 1 ? "searchResult" : "searchResults"
            }
    ...
    recordContextMenuActionsHistogram_(action) {
        ...
        this.browserService_.recordHistogram(this.actionMenuModel_.item.isActorVisit ? "HistoryPage.ActorContextMenuActions" : "HistoryPage.NonActorContextMenuActions", action, VisitContextMenuAction.MAX_VALUE)
    }
    onMoreFromSiteClick_() {
    ...
    canSearchMoreFromSite_() {
        return this.searchedTerm === "" || this.searchedTerm !== this.actionMenuModel_?.item.domain
    }
    ...
    showHistoryEmbeddings_() {
        return loadTimeData.getBoolean("enableHistoryEmbeddings") && !!this.searchedTerm && this.historyData_?.length > 0
    }
    onIsActiveChanged_() {
        if (this.isActive) {
            this.scrollTarget.addEventListener("scroll", this.scrollListener_)
...
class CrRouter extends EventTarget {
    ...
    hashChanged_() {
        ...
        if (this.hash_ !== oldHash) {
            this.dispatchEvent(new CustomEvent("cr-router-hash-changed",{
                bubbles: true,
                composed: true,
                detail: this.hash_
            }))
    ...
    urlChanged_() {
        ...
        if (oldPath !== this.path_) {
            this.dispatchEvent(new CustomEvent("cr-router-path-changed",{
                bubbles: true,
                composed: true,
                detail: this.path_
            }))
        ...
        if (oldQuery !== this.query_) {
            this.dispatchEvent(new CustomEvent("cr-router-query-params-changed",{
                bubbles: true,
                composed: true,
    ...
    updateState_() {
        ...
        url.pathname = pathPieces.map((piece => window.encodeURIComponent(piece))).join("/");
        if (this.query_) {
...
class HistoryRouterElement extends CrLitElement {
    ...
    willUpdate(changedProperties) {
        super.willUpdate(changedProperties);
        if (changedProperties.has("queryState") && changedProperties.get("queryState") || changedProperties.has("selectedPage") && changedProperties.get("selectedPage")) {
            this.serializeUrl()
        }
    }
    serializeUrl() {
    ...
    onPathChanged_(newPath) {
        ...
        const page = sections[0] || (window.location.search ? "history" : TABBED_PAGES[this.lastSelectedTab]);
...
class HistoryToolbarElement extends CrLitElement {
    ...
    computeSearchIconOverride_() {
        if (loadTimeData.getBoolean("enableHistoryEmbeddings") && TABBED_PAGES.includes(this.selectedPage)) {
    ...
    computeSearchPrompt_() {
        if (loadTimeData.getBoolean("enableHistoryEmbeddings") && TABBED_PAGES.includes(this.selectedPage)) {
            if (loadTimeData.getBoolean("enableHistoryEmbeddingsAnswers")) {
                const possiblePrompts = ["historyEmbeddingsSearchPrompt", "historyEmbeddingsAnswersSearchAlternativePrompt1", "historyEmbeddingsAnswersSearchAlternativePrompt2", "historyEmbeddingsAnswersSearchAlternativePrompt3", "historyEmbeddingsAnswersSearchAlternativePrompt4"];
...
class HistoryQueryManagerElement extends CrLitElement {
    ...
    queryHistory_(incremental) {
        ...
        let afterTimestamp;
        if (loadTimeData.getBoolean("enableHistoryEmbeddings") && this.queryState.after) {
            const afterDate = new Date(this.queryState.after);
            afterDate.setHours(0, 0, 0, 0);
            afterTimestamp = afterDate.getTime()
        }
        const browserService = BrowserServiceImpl.getInstance();
        const promise = incremental ? browserService.handler.queryHistoryContinuation() : browserService.handler.queryHistory(this.queryState.searchTerm, RESULTS_PER_PAGE, afterTimestamp ? afterTimestamp : null);
    ...
    onChangeQuery_(e) {
        ...
        if (changes.search !== null && changes.search !== this.queryState.searchTerm) {
            this.queryState = {
                ...this.queryState,
                searchTerm: changes.search
            };
            this.searchTermChanged_();
            needsUpdate = true
        }
        if (loadTimeData.getBoolean("enableHistoryEmbeddings") && changes.after !== null && changes.after !== this.queryState.after && (Boolean(changes.after) || Boolean(this.queryState.after))) {
            this.queryState = {
                ...this.queryState,
                after: changes.after
            };
    ...
    flushDebouncedQueryResultMetric_() {
        if (this.resultPendingMetricsTimestamp_ && performance.now() - this.resultPendingMetricsTimestamp_ >= QUERY_RESULT_MINIMUM_AGE) {
...
<div id="footer" ?hidden="${!this.showFooter_}">
  ...
  <div id="google-account-footer"
    ...
    <div ?hidden="${!this.showGMAOnly_}">Your Google Account may have other forms of browsing history at <a target="_blank" id="footerGoogleMyActivityLink" href="https://myactivity.google.com/myactivity/?utm_source=chrome_h">myactivity.google.com</a></div>
    <div ?hidden="${!this.showGAAOnly_}">Your Google Account may have your <a target="_blank" id="footerGeminiAppsActivityLink" href="https://myactivity.google.com/product/gemini">Gemini Apps Activity</a></div>
    <div ?hidden="${!this.showGMAAndGAA_}">Your Google Account may have other forms of browsing history at <a target="_blank" id="footerGoogleMyActivityLink" href="https://myactivity.google.com/myactivity/?utm_source=chrome_h">myactivity.google.com</a>, such as your <a target="_blank" id="footerGeminiAppsActivityLink" href="https://myactivity.google.com/product/gemini">Gemini Apps Activity</a></div>
  </div>
</div>
<!--_html_template_end_-->`
}
class HistorySideBarElement extends CrLitElement {
    ...
    willUpdate(changedProperties) {
        ...
        if (changedProperties.has("historyClustersEnabled") || changedProperties.has("historyClustersVisible")) {
            this.showHistoryClusters_ = this.historyClustersEnabled && this.historyClustersVisible
        }
    }
    updateFooterVisibility() {
        ...
        if (this.footerInfo.otherFormsOfHistory && this.footerInfo.geminiAppsActivity) {
        ...
        this.showGoogleAccountFooter_ = this.showGMAAndGAA_ || this.showGMAOnly_ || this.showGAAOnly_;
    ...
    getHistoryItemHref_() {
        return this.showHistoryClusters_ && TABBED_PAGES[this.selectedTab] === Page.HISTORY_CLUSTERS ? "/" + Page.HISTORY_CLUSTERS : "/"
    }
    getHistoryItemPath_() {
        return this.showHistoryClusters_ && TABBED_PAGES[this.selectedTab] === Page.HISTORY_CLUSTERS ? Page.HISTORY_CLUSTERS : Page.HISTORY
    }
}
...
class TrackedElementHandlerRemote {
    ...
    trackedElementVisibilityChanged(nativeIdentifier, visible, rect) {
        this.proxy.sendMessage(794093844, TrackedElementHandler_TrackedElementVisibilityChanged_ParamsSpec.$, null, [nativeIdentifier, visible, rect], false)
    }
    trackedElementActivated(nativeIdentifier) {
        this.proxy.sendMessage(603647975, TrackedElementHandler_TrackedElementActivated_ParamsSpec.$, null, [nativeIdentifier], false)
    }
    trackedElementCustomEvent(nativeIdentifier, customEventName) {
        this.proxy.sendMessage(2142885794, TrackedElementHandler_TrackedElementCustomEvent_ParamsSpec.$, null, [nativeIdentifier, customEventName], false)
    }
}
...
class HelpBubbleHandlerFactoryRemote {
    ...
    createHelpBubbleHandler(client, handler) {
        this.proxy.sendMessage(2083052675, HelpBubbleHandlerFactory_CreateHelpBubbleHandler_ParamsSpec.$, null, [client, handler], false)
    }
}
...
class HelpBubbleHandlerRemote {
    ...
    bindTrackedElementHandler(handler) {
        this.proxy.sendMessage(220948816, HelpBubbleHandler_BindTrackedElementHandler_ParamsSpec.$, null, [handler], false)
    }
    helpBubbleButtonPressed(nativeIdentifier, buttonIndex) {
        this.proxy.sendMessage(511221558, HelpBubbleHandler_HelpBubbleButtonPressed_ParamsSpec.$, null, [nativeIdentifier, buttonIndex], false)
    }
    helpBubbleClosed(nativeIdentifier, reason) {
        this.proxy.sendMessage(1031703002, HelpBubbleHandler_HelpBubbleClosed_ParamsSpec.$, null, [nativeIdentifier, reason], false)
    }
}
...
class HelpBubbleClientRemote {
    ...
    showHelpBubble(params) {
        this.proxy.sendMessage(663345711, HelpBubbleClient_ShowHelpBubble_ParamsSpec.$, null, [params], false)
    }
    toggleFocusForAccessibility(nativeIdentifier) {
        this.proxy.sendMessage(1525807692, HelpBubbleClient_ToggleFocusForAccessibility_ParamsSpec.$, null, [nativeIdentifier], false)
    }
    hideHelpBubble(nativeIdentifier) {
        this.proxy.sendMessage(737724029, HelpBubbleClient_HideHelpBubble_ParamsSpec.$, null, [nativeIdentifier], false)
    }
    externalHelpBubbleUpdated(nativeIdentifier, shown) {
        this.proxy.sendMessage(1183445149, HelpBubbleClient_ExternalHelpBubbleUpdated_ParamsSpec.$, null, [nativeIdentifier, shown], false)
    }
}
class HelpBubbleClientCallbackRouter {
    ...
    constructor() {
        ...
        this.helper_internal_.registerHandler(663345711, HelpBubbleClient_ShowHelpBubble_ParamsSpec.$, null, this.showHelpBubble.createReceiverHandler(false), false);
        this.toggleFocusForAccessibility = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1525807692, HelpBubbleClient_ToggleFocusForAccessibility_ParamsSpec.$, null, this.toggleFocusForAccessibility.createReceiverHandler(false), false);
        this.hideHelpBubble = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(737724029, HelpBubbleClient_HideHelpBubble_ParamsSpec.$, null, this.hideHelpBubble.createReceiverHandler(false), false);
        this.externalHelpBubbleUpdated = new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1183445149, HelpBubbleClient_ExternalHelpBubbleUpdated_ParamsSpec.$, null, this.externalHelpBubbleUpdated.createReceiverHandler(false), false);
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter()
    }
    removeListener(id) {
        return this.router_.removeListener(id)
...
const FindShortcutManager = ( () => {
    ...
    window.addEventListener("keydown", (e => {
        ...
        const element = e.composedPath()[0];
        if (!shortcutCtrlF.matchesEvent(e) && (element.tagName === "INPUT" || element.tagName === "TEXTAREA" || !shortcutSlash.matchesEvent(e))) {
            return
        }
...
function getHtml() {
          ...
          <div id="historyEmbeddingsDisclaimer" class="history-cards"
            ...
            <div id="historyEmbeddingsDisclaimerContent">
              ...
              <a id="historyEmbeddingsDisclaimerLink"
                  href="chrome://settings/ai/historySearch" target="_blank"
    ...
    <cr-lazy-render-lit id="drawer" .template='${ () => html`
      <cr-drawer heading="History" align="ltr">
...
class HistoryAppElement extends HistoryAppElementBase {
    ...
    #footerInfo_accessor_storage = {
        ...
        geminiAppsActivity: loadTimeData.getBoolean("isGlicEnabled") && loadTimeData.getBoolean("enableBrowsingHistoryActorIntegrationM1")
    };
    get footerInfo() {
        return this.#footerInfo_accessor_storage
    }
    ...
    get sessionList_() {
        return this.#sessionList__accessor_storage
    }
    set sessionList_(value) {
        this.#sessionList__accessor_storage = value
    }
    ...
    #tabsNames__accessor_storage = [loadTimeData.getString("historyListTabLabel"), loadTimeData.getString("historyClustersTabLabel")];
    get tabsNames_() {
    ...
    connectedCallback() {
        ...
        this.onHasOtherFormsChangedListenerId_ = this.callbackRouter_.onHasOtherFormsChanged.addListener((hasOtherForms => this.onHasOtherFormsChanged_(hasOtherForms)))
    }
    firstUpdated(changedProperties) {
        super.firstUpdated(changedProperties);
    ...
    willUpdate(changedProperties) {
        super.willUpdate(changedProperties);
        const changedPrivateProperties = changedProperties;
        if (changedPrivateProperties.has("historyClustersEnabled_") || changedPrivateProperties.has("historyClustersVisible_")) {
            this.showHistoryClusters_ = this.historyClustersEnabled_ && this.historyClustersVisible_
        }
        if (changedPrivateProperties.has("showHistoryClusters_") || changedPrivateProperties.has("enableHistoryEmbeddings_")) {
            this.showTabs_ = this.showHistoryClusters_ && !this.enableHistoryEmbeddings_
        }
    ...
    updated(changedProperties) {
        ...
        if (changedPrivateProperties.has("enableHistoryEmbeddings_") && this.enableHistoryEmbeddings_) {
    ...
    historyClustersSelected_() {
        return this.selectedPage_ === Page.HISTORY_CLUSTERS && this.showHistoryClusters_
    }
    onFirstRender_() {
    ...
    onVisibilityChange_() {
        ...
        } else if (document.visibilityState === "visible" && this.historyClustersViewStartTime_ === null) {
    ...
    onSelectAllCommand_() {
        if (this.$.toolbar.searchField.isSearchFocused() || this.syncedTabsSelected_() || this.historyClustersSelected_()) {
            return false
        }
    ...
    shouldShowSpinner_() {
        return this.queryState_.querying && !this.queryState_.incremental && this.queryState_.searchTerm !== ""
    }
    updateContentPage_() {
    ...
    updateTabsContentPage_() {
        this.tabsContentPage_ = this.selectedPage_ === Page.HISTORY_CLUSTERS && this.historyClustersEnabled_ && this.historyClustersVisible_ ? Page.HISTORY_CLUSTERS : Page.HISTORY
    }
    selectedPageChanged_(oldPage) {
        ...
        if (oldPage === Page.HISTORY_CLUSTERS && this.selectedPage_ !== Page.HISTORY_CLUSTERS) {
            this.recordHistoryClustersDuration_()
        }
        if (this.selectedPage_ === Page.HISTORY_CLUSTERS) {
            this.historyClustersViewStartTime_ = new Date
    ...
    updateScrollTarget_() {
        ...
        if (topLevelIronPages.selectedItem && topLevelIronPages.selectedItem === topLevelHistoryPage) {
    ...
    recordHistoryPageView_() {
        ...
        case Page.HISTORY_CLUSTERS:
            ...
            break;
        case Page.SYNCED_TABS:
            histogramValue = this.signInState_ === HistorySignInState.SIGNED_IN_SYNCING_TABS ? HistoryPageViewHistogram.SYNCED_TABS : HistoryPageViewHistogram.SIGNIN_PROMO;
            break;
        default:
    ...
    shouldShowHistoryEmbeddings_() {
        ...
        return this.queryState_.searchTerm.split(" ").filter((part => part.length > 0)).length >= loadTimeData.getInteger("historyEmbeddingsSearchMinimumWordCount")
    }
...
export {BrowserProxyImpl, BrowserServiceImpl, ClusterAction, CrRouter, HISTORY_EMBEDDINGS_ANSWERS_PROMO_SHOWN_KEY, HISTORY_EMBEDDINGS_PROMO_SHOWN_KEY, HistoryAppElement, HistoryEmbeddingsBrowserProxyImpl, PageHandlerRemote as HistoryEmbeddingsPageHandlerRemote, HistoryEmbeddingsPromoElement, HistoryItemElement, HistoryListElement, HistoryPageViewHistogram, HistorySideBarElement, HistorySignInState, HistoryToolbarElement, MetricsProxyImpl, PageCallbackRouter$1 as PageCallbackRouter, PageHandlerRemote$1 as PageHandlerRemote, RelatedSearchAction, VisitAction, VisitContextMenuAction, VisitType, ensureLazyLoaded, getTrustedHTML};
